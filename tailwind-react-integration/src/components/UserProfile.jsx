  ...
  return (
    <div className="bg-gray-100 p-4 sm:p-4 md:p-8 max-w-xs md:max-w-sm mx-auto my-20 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 ease-in-out">
      <img
        ...
        alt="User"
        className="rounded-full mx-auto sm:w-24 sm:h-24 w-24 h-24 md:w-36 md:h-36 transform transition-transform duration-300 ease-in-out hover:scale-110"
      />
      <h1 className="text-lg md:text-xl text-blue-800 hover:text-blue-500 my-4 transition-colors duration-300">John Doe</h1>
